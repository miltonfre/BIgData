...
namespace MySparkStreamingApp2ML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Personal\Master Maharishi\Classes\BigData\FInalProject\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\Usuario\AppData\Local\Temp\MLVSTools\mySparkStreamingApp2ML\mySparkStreamingApp2ML.Model\MLModel.zip";
